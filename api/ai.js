...
Keep habit names short (under 8 words). Consider reducing days for struggling habits.`;
    ...
    case 'schedule-tasks':
      console.log('schedule-tasks action received');
      console.log('goal length:', goal ? goal.length : 'undefined');
      ...
      userPrompt = goal || 'No goal provided'; // The goal contains the full scheduling prompt
      break;

    case 'breakdown-task':
      console.log('breakdown-task action received');
      ...
      userPrompt = goal || 'No goal provided'; // The goal contains the full breakdown prompt
      break;
  ...
  console.log('Making OpenAI request with systemPrompt length:', systemPrompt?.length, 'userPrompt length:', userPrompt?.length);
